    ...
    <nav className="flex flex-row justify-between items-center w-full p-3 bg-white fixed z-20">
      ...
      >
        ...
        <li className="py-2 md:hidden w-full flex flex-col gap-3 mt-2">
          <button className="text-sm font-medium hover:text-red-800 transition-colors">Login</button>
      ...
      <div className="flex flex-row gap-6 mr-2 items-center">
        ...
        <button className="hidden md:block text-sm font-medium hover:text-red-800 transition-colors">Login</button>

        {/* Get Started button - hidden on mobile */}
        <button className="hidden md:block bg-red-800 text-white px-4 py-1.5 rounded-md text-sm font-medium hover:bg-red-900 active:scale-95 transition-all">
          Get Started
        </button>
        {/* Cart */}
